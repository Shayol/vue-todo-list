<template>
  <div id="app" class="container page">
    ...
    <div class="footer">
      ...
      <a href="https://github.com/Shayol/vue-todo-list" class="footer__github">
        <svg class="footer__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120.78 117.79">
          <title>Asset 1</title>
          <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
              ...
              <path class="cls-2" d="M25.32,89.43c-.29.27-.85.14-1.24-.28a.92.92,0,0,1-.17-1.25c.3-.27.84-.14,1.24.28s.47,1,.17,1.25Z" />
              ...
              <path class="cls-2" d="M40.4,98.58c0,.5-.56.91-1.28.92s-1.3-.38-1.31-.87.56-.92,1.29-.93,1.3.39,1.3.88Z" />
